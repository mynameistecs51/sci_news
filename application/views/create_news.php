...
<body>
  ...
  <h3>สร้าง content ขนาดกระดาษ A3 แนวนอน:</h3>กลับหน้าหลัก <a href="index">index</a>  <a class="add-box" href="#">add textarea  </a>
  ...
  <div id="draggable" class="ui-widget-content" name="draggable[]">
   ...
   <input type="file" id="images[]" class="hiddent-file" name="images[]" size="20" onchange="PreviewImage();" />
